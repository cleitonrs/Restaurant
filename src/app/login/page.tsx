...
const LoginPage = () => {
  return (
    <div className='bg-white p-4 h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex items-center justify-center'>
      {/* Box */}
      <div className='h-full shadow-2xl rounded-md flex flex-col md:flex-row md:h-[70%] md:w-full lg:w-[60%] 2xl:w-1/2'>
        ...
        <div className='flex flex-col p-10 gap-8 md:w-1/2'>
          ...
          <p className='text-sm'> 
            Algum problema? <Link className='underline' href='/'> Contate-nos </Link> 
          </p>
        </div>
      </div>
    </div>
